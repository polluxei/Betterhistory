...
scripts = [
  ...
  'scripts/lib/sites_hasher.js',
  'scripts/lib/syncer.js',
  'scripts/chrome/weeks_history.js',
  'scripts/chrome/week_history.js',
  'scripts/chrome/search_history.js',
  'scripts/chrome/day_history.js',
  'scripts/persistence/tag.js',
  'scripts/persistence/remote.js',
  ...
  'scripts/presenters/all_weeks_presenter.js',
  'scripts/router.js',
  'scripts/init/tag_feature.js',
