class BH.Presenters.VisitsHistoryPresenter extends BH.Presenters.Base
...
visitData = (visit) ->
  _.extend visit,
    isGrouped: false
    visit.time = new Date(visit.lastVisitTime).toLocaleTimeString(chrome.i18n.getUILanguage())
